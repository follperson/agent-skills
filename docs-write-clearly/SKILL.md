---
name: docs-write-clearly
description: "Draft, revise, and audit reader-first technical and product documentation. Use when working on developer docs, procedures, runbooks, release notes, technical explanations, help-center content, READMEs, or UI copy where clarity, source fidelity, accessibility, or global readability matters. Applies Google Developer Documentation Style Guide principles while preserving the author's facts, uncertainty, terminology, and voice. Do not auto-apply to marketing, legal, academic, fictional, or personal writing unless the user asks for this style. Triggers: write docs, revise this draft, clean up this README, tighten this prose, make this clearer, style guide, Google style, technical writing, release notes, runbook, procedure, help center article, UI copy, microcopy, docs review, prose audit, plain language, active voice, sentence case."
---
